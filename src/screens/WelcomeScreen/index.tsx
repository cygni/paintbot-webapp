...
import introImage1 from '/images/welcome1.png';
import introImage2 from '/images/welcome2.png';
  ...
  return (
    <>
      <Paper>
        ...
        <PaperRow>Paintbot is the colorful game where your bot competes with other bots about the board.</PaperRow>
        <PaperRow>
        ...
        <PaperRow>
          <Link to={'readme'}>Getting started is really easy.</Link> Clone an example Paint Bot and get going!
        </PaperRow>
